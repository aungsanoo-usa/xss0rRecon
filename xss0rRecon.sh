...
run_step_3() {
    ...
    dnsbruter -d "$domain_name" -w /usr/share/wordlists/amass/subdomains-top1mil-110000.txt -c 200 -wt 100 -o output-dnsbruter.txt -ws wild.txt || handle_error "dnsbruter"
    sleep 5
